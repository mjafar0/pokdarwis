...
class Helpers
{
   ...
   */
  public static function getNameOfPage ($action = null)
  {
   ...
   */
  public static function getActionOfPage ($action = null)
  {
  ...
  {
    return route(Helpers::getNameOfPage('index'));    
  }
  /**
  ...
  public static function tanggalKemarin($format)
  {
    ...
    return Helpers::tanggal($format, $kemarin);
  }
  public static function tambahJam($jam, $format, $date=null, $english=false)
  {
    ...
    return Helpers::tanggal($format, $tanggal->format($format), $english);
  }
  ...
  */
  ...
  public static function getBulanRomawi($no_bulan = null) 
  {
    ...
    return Helpers::$daftar_bulan_romawi[$no_bulan];
  }
  /**
  ...
  */
  public static function getNamaHari($no_hari = null)
  {
    if ($no_hari == null)
    {
      return Helpers::$daftar_nama_hari;
    }
    else
    {
      return Helpers::$daftar_nama_hari[$no_hari];
    }    
  }
  /**
  * casting ke integer	
  ...
  */
  ...
  {
    return Helpers::public_path("exported/$path");
  }
  /**
  ...
  */
  public static function array_change_key_case_recursive($arr, $case = CASE_LOWER)
  {
    return array_map(function($item) {
      if(is_array($item)) 
      {
        $item = \Helpers::array_change_key_case_recursive($item);
      }
      return $item;
