...
@section('main')
{!! html()->form('put', route('settings-users-superadmin.update', ['id' => $data->id]))->open() !!}
<div class="card shadow-sm border-0">
    <div class="card-body">       
        {!! html()->label('name', 'Nama User') !!}
        {!! html()->text('name')->class('form-control')->value($data->name) !!}

        {!! html()->label('email', 'Email') !!}
        {!! html()->email('email')->class('form-control')->value($data->email) !!}
